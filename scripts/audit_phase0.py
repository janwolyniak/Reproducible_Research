...
The result is written to ``outputs/logs/source_audit.md`` by default.
...
def _load_dependencies():
    try:
        ...
        raise SystemExit(
            "Source audit requires pandas and numpy to read tracked "
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--report",
        type=Path,
        default=REPO / "outputs" / "logs" / "source_audit.md",
